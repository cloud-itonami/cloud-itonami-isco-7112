(ns bricklaying.actor
  "BricklayingActor — the ISCO-08 7112 masonry job-site
  ...
  accountingsupport.actor (and closely on cloud-itonami-isco-7111's
  housebuilder.actor for the job-site-coordination domain shape).
  ...
  The unconditional invariant: the Bricklaying Advisor can never
  directly commit an operating record the BricklayingGovernor
  refuses, and can never make this actor finalize a
  masonry-work-execution decision (e.g. a specific wall-laying or
  mortar-joint step) or override a site safety officer's/foreman's
  ...
  SCHEDULING/LOGISTICS ONLY — it never performs masonry work or
  authorizes masonry-work execution itself."
...
(defn build-graph
  "Build a compiled BricklayingActor graph. `store` implements
  `bricklaying.store/Store`. `advisor` implements
  `bricklaying.advisor/Advisor` (defaults to `mock-advisor`).
